...
class Logger {
   public:
    ...
    Logger(std::vector<std::string> var_names, bool verbose) : _var_names{var_names}, verbose{verbose} {
   ...
   private:
    ...
    void updateColumnWidths(double logLikelihood, const Col<double>& variances, double timeCost);
