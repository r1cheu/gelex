...
#ifndef GELEX_BAYES_GENETIC_KERNEL_COEFFICIENT_LIKELIHOOD_H_
#define GELEX_BAYES_GENETIC_KERNEL_COEFFICIENT_LIKELIHOOD_H_
...
#endif  // GELEX_BAYES_GENETIC_KERNEL_COEFFICIENT_LIKELIHOOD_H_
