...
#ifndef GELEX_ALGO_INFER_MCMC_SAMPLERS_STICK_BREAKING_H_
#define GELEX_ALGO_INFER_MCMC_SAMPLERS_STICK_BREAKING_H_
...
#endif  // GELEX_ALGO_INFER_MCMC_SAMPLERS_STICK_BREAKING_H_
