...
#ifndef GELEX_ALGO_INFER_MCMC_SAMPLERS_GIBBS_R_POLICY_H_
#define GELEX_ALGO_INFER_MCMC_SAMPLERS_GIBBS_R_POLICY_H_
...
#endif  // GELEX_ALGO_INFER_MCMC_SAMPLERS_GIBBS_R_POLICY_H_
