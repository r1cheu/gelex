...
#ifndef GELEX_ALGO_INFER_MCMC_STEPS_JOINT_GENETIC_STEP_H_
#define GELEX_ALGO_INFER_MCMC_STEPS_JOINT_GENETIC_STEP_H_
...
#endif  // GELEX_ALGO_INFER_MCMC_STEPS_JOINT_GENETIC_STEP_H_
