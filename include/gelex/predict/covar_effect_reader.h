...
#ifndef GELEX_PREDICT_COVAR_EFFECT_READER_H
#define GELEX_PREDICT_COVAR_EFFECT_READER_H
...
class CovarEffectReader
{
   public:
    explicit CovarEffectReader(const std::filesystem::path& param_file_path);
...
#endif  // GELEX_PREDICT_COVAR_EFFECT_READER_H
