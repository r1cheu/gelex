...
#ifndef GELEX_DATA_GENOTYPE_DETAIL_STATISTIC_POLICY_H_
#define GELEX_DATA_GENOTYPE_DETAIL_STATISTIC_POLICY_H_
...
template <typename T>
concept StatisticPolicy = requires(
    T policy,
    LocusContext& locus,
    gelex::LocusStatistic& statistic) {
...
struct SamplePolicy
{
    static auto process(LocusContext& context, gelex::LocusStatistic& statistic)
        -> void
    {
   ...
   private:
    static auto center(LocusContext& context, gelex::LocusStatistic& statistic)
        -> void
    {
    ...
    static auto stddev(LocusContext& context, gelex::LocusStatistic& statistic)
        -> void
    {
...
struct HWEPolicy
{
   ...
   private:
    ...
    static auto stddev(
        ...
        gelex::LocusStatistic& statistic) -> void
    {
        if constexpr (GT == gelex::GeneticMode::A)
        {
            statistic.stddev
...
#endif  // GELEX_DATA_GENOTYPE_DETAIL_STATISTIC_POLICY_H_
