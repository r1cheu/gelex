...
#ifndef GELEX_DATA_READER_SNP_EFFECT_READER_H_
#define GELEX_DATA_READER_SNP_EFFECT_READER_H_
...
class SnpEffectReader
{
   public:
    explicit SnpEffectReader(const std::filesystem::path& snp_effect_path);
...
#endif  // GELEX_DATA_READER_SNP_EFFECT_READER_H_
