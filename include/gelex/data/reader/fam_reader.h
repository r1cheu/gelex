...
#ifndef GELEX_DATA_READER_FAM_READER_H_
#define GELEX_DATA_READER_FAM_READER_H_
...
{
   public:
    explicit FamReader(const std::filesystem::path& path);
...
#endif  // GELEX_DATA_READER_FAM_READER_H_
