...
#ifndef GELEX_POST_RESIDUAL_POSTERIOR_PROCESSOR_H_
#define GELEX_POST_RESIDUAL_POSTERIOR_PROCESSOR_H_
...
class ResidualPosteriorProcessor
{
   public:
...
#endif  // GELEX_POST_RESIDUAL_POSTERIOR_PROCESSOR_H_
