...
#ifndef GELEX_MODEL_BAYES_WRITER_MCMC_RESULT_WRITER_H_
#define GELEX_MODEL_BAYES_WRITER_MCMC_RESULT_WRITER_H_
...
#endif  // GELEX_MODEL_BAYES_WRITER_MCMC_RESULT_WRITER_H_
