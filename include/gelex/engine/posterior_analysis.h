...
#ifndef GELEX_ENGINE_POSTERIOR_ANALYSIS_H_
#define GELEX_ENGINE_POSTERIOR_ANALYSIS_H_
...
class PosteriorAnalysisEngine
{
   ...
   private:
    ...
    std::vector<io::BinaryReader> readers_;
...
#endif  // GELEX_ENGINE_POSTERIOR_ANALYSIS_H_
