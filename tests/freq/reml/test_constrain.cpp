...
namespace gelex
{
TEST_CASE("Constrain Tests", "[freq][reml][constrain]")
{
...
TEST_CASE("Constrain Sum Preservation", "[freq][reml][constrain]")
{
...
TEST_CASE("Constrain Different y_ssq Values", "[freq][reml][constrain]")
{
...
TEST_CASE("Constrain Edge Cases", "[freq][reml][constrain]")
{
