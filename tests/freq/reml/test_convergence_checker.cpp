...
namespace gelex
{
TEST_CASE("ConvergenceChecker Constructor", "[freq][reml][convergence]")
{
...
TEST_CASE("ConvergenceChecker First Call", "[freq][reml][convergence]")
{
...
TEST_CASE(
    "ConvergenceChecker Convergence Conditions",
    "[freq][reml][convergence]")
{
...
TEST_CASE("ConvergenceChecker State", "[freq][reml][convergence]")
{
...
TEST_CASE(
    "ConvergenceChecker Vector Size Handling",
    "[freq][reml][convergence]")
{
...
TEST_CASE("ConvergenceChecker Boundary Conditions", "[freq][reml][convergence]")
{
...
TEST_CASE("ConvergenceChecker Multiple Iterations", "[freq][reml][convergence]")
{
