...
TEST_CASE(
    "NormalSampler updates prior variance",
    "[bayes][stats][conjugate][normal]")
{
...
TEST_CASE(
    "BetaSampler is reproducible under fixed seed",
    "[bayes][stats][conjugate][beta]")
{
...
TEMPLATE_TEST_CASE(
    ...
    "[bayes][stats][conjugate][dirichlet]",
    float,
    double)
{
    using T = TestType;
