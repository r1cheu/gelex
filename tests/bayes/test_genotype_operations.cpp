...
auto adapt_raw_impl(RawDotImpl impl)
{
    return [impl](
...
auto adapt_raw_impl(RawAxpyImpl impl)
{
    return [impl](
               std::span<const std::uint8_t> genotype_column,
               const Eigen::Ref<const Eigen::Array4d>& lut,
...
auto check_dot_impl(Dot impl) -> void
{
...
auto check_axpy_impl(Axpy impl) -> void
{
...
TEST_CASE(
    ...
    "[bayes][genotype_operations][dot]")
{
    check_dot_impl(adapt_raw_impl(gelex::bayes::detail::dot_scalar));
}
    ...
    "[bayes][genotype_operations][dot]")
{
    ...
    check_dot_impl(adapt_raw_impl(gelex::bayes::detail::dot_avx2));
}
    ...
    "[bayes][genotype_operations][dot]")
{
    ...
    check_dot_impl(adapt_raw_impl(gelex::bayes::detail::dot_avx512));
}
