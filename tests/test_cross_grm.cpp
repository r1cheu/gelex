...
//     "/data/train"; const std::string test_bed = std::string(GELEX_TESTS_DIR)
//     + "/data/test"; const std::string test_missmatch_bed
//         = std::string(GELEX_TESTS_DIR) + "/data/test_missmatch";
...
//     {
//         gelex::CrossGRM cgrm(train_bed, std::move(p_major),
//         add_scale_factor); MatrixXd grm = cgrm.compute(test_bed);
//
...
//             train_bed, p_major, scale_factor, 10, target_individuals);
//
