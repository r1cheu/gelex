...
tools: Glob, Grep, Read, WebFetch, WebSearch, Edit, Write, NotebookEdit, LSP, mcp__plugin_context7_context7__resolve-library-id, mcp__plugin_context7_context7__query-docs
model: sonnet
color: cyan
memory: project
---
